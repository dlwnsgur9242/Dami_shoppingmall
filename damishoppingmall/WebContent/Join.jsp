...
<head>
    ...
    <script type="text/javascript">
		...
		function checkValue() {
			...
			else if(!document.userInfo.passwd.value){
				alert("비밀번호를 입력하세요.");
				return false;
			}
			
			// 비밀번호와 비밀번호 확인에 입력된 값이 동일한지 확인
			else if(document.userInfo.passwd.value != document.userInfo.PWD_RE.value ){
...
<body>
   <!-- div 왼쪽, 오른쪽 바깥여백을 auto로 주면 중앙정렬된다.  -->
	<div id="wrap">
		<br><br>
		<b><font size="600" color="gray">회원가입</font></b>
		<br><br>
		...
		<form method="post" action="Pro/JoinPro.jsp" name="userInfo"
            ...
            <br>
            <input type="submit" value=" 가 입 ">  <input type="button" value=" 취 소 " onclick="goLogin()">
        </form>
    </div>
</body>
</html>